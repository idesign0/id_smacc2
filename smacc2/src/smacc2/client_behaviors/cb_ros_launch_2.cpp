...
// NOTE: the real CbRosLaunch2::onOrthogonalAllocation<>() is the inline member template in
// cb_ros_launch_2.hpp. This stray namespace-scope duplicate (missing the CbRosLaunch2::
// qualifier) called SmaccAsyncClientBehavior::onOrthogonalAllocation<>() with no object ->
